...
tlp_f.mr_addr32 = ProtoField.uint32("nettlp.tlp.mr_addr32", "Address 32 bit", base.HEX)
tlp_f.mr_addr32_rsvd = ProtoField.uint32("nettlp.tlp.mr_addr32_rsvd", "Reserved_32b")

tlp_f.mr_addr64 = ProtoField.uint64("nettlp.tlp.mr_addr64", "Address 64 bit", base.HEX)
tlp_f.mr_addr64_rsvd = ProtoField.uint64("nettlp.tlp.mr_addr64_rsvd", "Reserved_64b")
...
function nettlp_proto.dissector(buffer, pinfo, tree)
	...
	if fmttype == 0x00 then  -- MRd_3DW
		...
		tlp_subtree:add(tlp_f.mr_addr32_rsvd, buffer(17,1):bitfield(6,2))
	elseif fmttype == 0x20 then  -- MRd_4DW
		...
		tlp_subtree:add(tlp_f.mr_addr64_rsvd, buffer(21,1):bitfield(6,2))
